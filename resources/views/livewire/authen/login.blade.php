        ...
        <div class="main-container min-h-screen text-black dark:text-white-dark">
            <div>
                <div class="absolute inset-0">
                    <img src="{{ asset('rvms/assets/images/auth/bg-gradient.png') }}" alt="image" class="h-full w-full object-cover" />
                </div>
                <div class="relative flex min-h-screen items-center justify-center bg_map bg-cover bg-center bg-no-repeat px-6 py-10 dark:bg-[#060818] sm:px-16">
                    <img src="{{ asset('rvms/assets/images/auth/coming-soon-object1.png') }}" alt="image" class="absolute left-0 top-1/2 h-full max-h-[893px] -translate-y-1/2" />
                    <img src="{{ asset('rvms/assets/images/auth/coming-soon-object2.png') }}" alt="image" class="absolute left-24 top-0 h-40 md:left-[30%]" />
                    <img src="{{ asset('rvms/assets/images/auth/coming-soon-object3.png') }}" alt="image" class="absolute right-0 top-0 h-[300px]" />
                    <img src="{{ asset('rvms/assets/images/auth/polygon-object.svg') }}" alt="image" class="absolute bottom-0 end-[28%]" />
                    ...
                    <div class="relative flex flex-col justify-center rounded-md bg-white/60 backdrop-blur-lg dark:bg-black/50 px-6 lg:min-h-[758px] py-20">
                        <div class="mx-auto w-full max-w-[440px] anuphan-font">
                            <div class="mb-10">
                                <h1 class="text-3xl font-extrabold !leading-snug text-primary md:text-4xl">ลงชื่อเข้าใช้งาน</h1>
                            ...
                            <form class="space-y-5 dark:text-white" @submit.prevent="#">
                                ...
                                <div>
                                    <label class="flex cursor-pointer items-center">
                                        ...
                                        <span class="text-white-dark">Show Password</span>
                                    </label>
                                </div>
                                <button
                                    type="submit"
                            ...
                            <div class="text-center dark:text-white">
                                <div class=" flex flex-col md:flex-row">
                                    <div>ท่านยังไม่มีบัญชีผู้ใช้งานใช่หรือไม่ ?</div>
                                    <div>
                                        <a 
                                        href="#" 
                                        class="lg:ml-2 md:ml-0 uppercase text-primary underline transition hover:text-black dark:hover:text-white" >
                                        แจ้งความประสงค์ขอมีบัญชีผู้ใช้งาน
                                        </a>
                                    </div>
                                </div>
                            </div>
